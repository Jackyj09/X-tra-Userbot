...
call("pip install --upgrade pip".split(" "), stdout=PIPE, stderr=PIPE)
call("pip3 install -U https://github.com/LonamiWebs/Telethon/archive/master.zip".split(" "), stdout=PIPE, stderr=PIPE)
